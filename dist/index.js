...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const spaceList = yield tuya.request({
...
app.post('/api/register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield tuya.user.registerUser({ username, password, country_code });
        if (response.success) {
            ...
            try {
                ...
                const spaceResponse = yield tuya.request({
...
app.get('/api/token/:refreshToken', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.get('/api/device/:deviceId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { device_id } = req.params;
    try {
        const response = yield tuya.device.detail({ device_id: device_id });
        res.status(200).json(response);
    }
    catch (error) {
        if (error instanceof Error) {
...
app.get('/api/device/bulk/:deviceIds', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
app.get('/api/space/list/:space_ids', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { space_ids } = req.params;
    const num = parseInt(space_ids, 10);
    const signHeaders = yield tuya.client.getSignHeaders(`/v2.0/cloud/space/${space_ids}/resource`, 'GET', {}, {});
    const headers = Object.assign(Object.assign({}, signHeaders), { 'Content-Type': 'application/json' });
...
app.get('/api/space/:spaceid', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
app.post('/api/pairqrcode', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
app.post('/api/CreateTempPass', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, deviceId, password, startTime, // Start time in minutes
    endTime, // End time in minutes
    workingDayBinary, startTimediff, endTimediff
    // ticketId,    // Optional, depending on your implementation
     } = req.body;
    try {
        // Step 1: Obtain ticket_id and ticket_key
        const ticketResponse = yield tuya.request({
            method: 'POST',
        ...
        // }
        function decrypt_AES_128(data, secretKey) {
            console.log("First");
        ...
        //   return encrypted;
        // }
        function encrypt_AES_128(data, secretKey) {
            const key = crypto.enc.Utf8.parse(secretKey);
...
app.get('/api/get-temp-passwords', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post('/api/createspace', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name } = req.body;
    try {
        const response = yield tuya.request({
            path: '/v2.0/cloud/space/creation',
...
app.get('/api/startdiscover', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // const response = 
...
app.get('/api/stopdiscover', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield tuya.deviceRegistration.stopDiscover;
        res.status(200).json(response);
    }
    catch (error) {
        if (error instanceof Error) {
...
app.post('/api/control-device', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { device_id, commands } = req.body;
    try {
        const response = yield tuya.deviceFunction.command({ device_id, commands });
        res.status(200).json(response);
    }
    catch (error) {
        if (error instanceof Error) {
